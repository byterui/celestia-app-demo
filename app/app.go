...
import (
	...
	tokenfactorymodule "celestia-app-demo/x/tokenfactory"
	tokenfactorymodulekeeper "celestia-app-demo/x/tokenfactory/keeper"
	tokenfactorymoduletypes "celestia-app-demo/x/tokenfactory/types"

	swapmodule "celestia-app-demo/x/swap"
	swapmodulekeeper "celestia-app-demo/x/swap/keeper"
	swapmoduletypes "celestia-app-demo/x/swap/types"

	appparams "celestia-app-demo/app/params"
	"celestia-app-demo/docs"
)

const (
	AccountAddressPrefix = "cosmos"
	Name                 = "celestia-app-demo"
)
...
func NewApp(
	...
	*/
	...
	app.TokenFactoryKeeper = *tokenfactorymodulekeeper.NewKeeper(
		...
		app.AccountKeeper,
		app.BankKeeper.WithMintCoinsRestriction(tokenfactorymoduletypes.NewTokenFactoryDenomMintCoinsRestriction()),
		app.DistrKeeper,
	)
