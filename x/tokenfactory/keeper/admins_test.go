...
func (suite *IntegrationTestSuite) TestAdminMsgs() {
	addr0bal := int64(0)
	addr1bal := int64(0)
...
func (suite *IntegrationTestSuite) TestMintDenom() {
	var addr0bal int64
...
func (suite *IntegrationTestSuite) TestBurnDenom() {
	var addr0bal int64
...
func (suite *IntegrationTestSuite) TestChangeAdminDenom() {
	for _, tc := range []struct {
		desc                    string
